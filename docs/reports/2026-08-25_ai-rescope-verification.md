...
> + 调研成果 + 决策点（E1~E7）。
> **已裁决（2026-08-25 同日第五轮）：E1=B'（伴随进程+文件协议）；E2~E7 按 §5
> 推荐包执行；另增联动需求 N1~N4（双向单击定位/AI 笔记成对粒度/脉络跳转/zcode
> 联动）。落档=蓝图 §4.3+D5 修订注记/ADR-0014/ADR-0015/ROADMAP（主线链+P7-C 增补
> +P7-G 增容 SR2-AI-06~10+P7-H 新节+P8+ 辨析）/AGENTS 负面清单措辞/INV-19~21
> 预登记/ai-module-plan DDL 修订。**
